    ...
    <Dialog>
      ...
      <DialogContent>
        ...
        <form action={handleUsage}  className="flex justify-center gap-4 mt-4">
          <div>
            <DialogClose asChild>
              <Button type="button" className=" text-white rounded-full bg-gray-300 border border-gray-300 hover:opacity-70 hover:bg-gray-300">いいえ</Button>
            </DialogClose>
          </div>
          <div>
            <Button type="submit" className=" text-white rounded-full bg-blue-500 border border-blue-500 hover:opacity-70 hover:bg-blue-500">はい</Button>
          </div>
        </form>
      </DialogContent>
    </Dialog>
