           ...
           {toUserSelected && 'email' in toUserSelected && (
            <div className="mb-2 mt-8">
              ...
              <div className="mt-8 mb-4 text-center">
                <Button onClick={handleConfirm} className="text-white rounded-full px-10 h-[42px] bg-[#1eb98c] border border-[#1eb98c] hover:opacity-70 hover:bg-[#1eb98c]">チケットを移行する</Button>
              </div>
            </div>
          )}
        </div>
